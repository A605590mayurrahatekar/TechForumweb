...
define(['angular'], function (angular) {
    ...
    var ChallengeCtrl = function ($scope, $state, $http, $location, $anchorScroll, $stateParams,$timeout,$filter,SessionService,AuthService,notify,$ionicLoading) {
        $scope.sessions = [];
        $scope.starProp = 0;
        ...
        $scope.registerQuestionAnswer = function(question,value,optionId) {
    ...
    ChallengeCtrl.$inject = ['$scope', '$state', '$http', '$location', '$anchorScroll', '$stateParams','$timeout','$filter','SessionService','AuthService','notify','$ionicLoading'];
